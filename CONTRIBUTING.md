...
4. Mỗi module `.vi` phải import trực tiếp dependency của chính nó; không dựa vào thứ tự import của facade. Giữ `gói/ứng dụng` ở mức lifecycle chung, còn full stack nằm ở `gói/dựng/ứng dụng.vi`. Đường dẫn package có khoảng trắng phải được đặt trong dấu nháy, ví dụ `nhập "gói/mạng/main.vi";`.
